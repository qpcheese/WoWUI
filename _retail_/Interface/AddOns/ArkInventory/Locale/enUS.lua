...
--	restack
	...
	L["RESTACK_CONSOLIDATE_DESC"] = "Fill empty slots in the %1$s with crafting items from lower priority bags within the same panel"
	L["RESTACK_CONSOLIDATE_DESC_PROFESSION"] = "Fill empty profession bag slots in the %1$s with crafting items from lower priority bags within the same panel"
