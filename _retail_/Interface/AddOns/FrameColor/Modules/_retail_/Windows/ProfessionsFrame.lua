...
function module:Recolor(color1, color2, color3, color4, desaturation)
    ...
    for _, texture in pairs({
        ...
        ProfessionsFrame.OrdersPage.BrowseFrame.NpcOrdersButton.Left,
        ProfessionsFrame.OrdersPage.BrowseFrame.NpcOrdersButton.Middle,
        ProfessionsFrame.OrdersPage.BrowseFrame.NpcOrdersButton.Right,
        ProfessionsFrame.OrdersPage.BrowseFrame.PersonalOrdersButton.Left,
        ProfessionsFrame.OrdersPage.BrowseFrame.PersonalOrdersButton.Middle,
        ProfessionsFrame.OrdersPage.BrowseFrame.PersonalOrdersButton.Right,
    }) do
        texture:SetDesaturation(desaturation)
        texture:SetVertexColor(color3.r, color3.g, color3.b, color3.a)
    end
    --reskin scrollbar
