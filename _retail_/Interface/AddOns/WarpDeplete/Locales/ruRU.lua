...
L["Difference to best kill time"] = "Разница с лучшим временем убийства"
L["Difference to last kill time"] = "Разница с последним временем убийства"
...
L["General"] = "Общие"
L["Hidden"] = "Скрытый"
L["How to display timing differences in the objective display"] = "Отображение разницы во времени на именах боссов"
...
L["New best objective clear time"] = "Новое лучшее время убийства босса"
L["NONE"] = true
...
L["Objectives time difference"] = "Разница во времени имён боссов"
...
L["Show forces percent above 100%"] = "Показать процент противников выше 100%"
L["Show forces count in tooltip"] = "Показать счётчик противников во всплывающей подсказке"
L["Show forces percentages exceeding 100% for the above format options"] = "Показывать процентное соотношение противников, превышающее 100%, для указанных выше параметров формата"
...
L["Shows the current forces percentage including pull (e.g. 87.84%)"] = "Показывает текущий процент противников, включая пулл (например, 87.84%)"
L["Show the forces glow in demo mode"] = "Показывает свечение противников в демо-режиме"
...
L["Size"] = "Размер"
L["Slower objective clear time"] = "Замедленное время очистки боссов"
