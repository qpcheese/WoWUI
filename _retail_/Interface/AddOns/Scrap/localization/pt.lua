...
L.ToggleMousehover = 'Marcar Item Sob o Mouse como Lixo ou Nao'
...
-- tutorials
L.Tutorial_Welcome = 'Bem-vindo ao Scrap, a solução inteligente para vender seus itens inúteis. Este pequeno tutorial irá ajudá-lo a começar a vender seu lixo. Vamos começar?'
L.Tutorial_Button = 'O Scrap venderá automaticamente todo o seu lixo sempre que você visitar um comerciante. Mas você pode vendê-lo manualmente: basta clicar no botão do Scrap.'
