...
options.raidBuffs = {
	...
	get = function(info)
		return E.db.mui.raidBuffs[info[#info]]
	end,
	args = {
		header = {
			order = 1,
			...
			args = {
				enable = {
					...
					set = function(info, value)
						E.db.mui.raidBuffs.enable = value
						module:Visibility()
					end,
				},
				space1 = {
					...
					name = "",
					hidden = function()
						return not E.db.mui.raidBuffs.enable
					end,
				},
				visibility = {
					type = "select",
					...
					set = function(info, value)
						E.db.mui.raidBuffs.visibility = value
						module:Visibility()
					end,
					values = {
						["DEFAULT"] = DEFAULT,
				...
				alpha = {
					...
					set = function(info, value)
						E.db.mui.raidBuffs.alpha = value
						E:StaticPopup_Show("PRIVATE_RL")
					end,
				},
				class = {
					...
					set = function(info, value)
						E.db.mui.raidBuffs.class = value
						E:StaticPopup_Show("PRIVATE_RL")
					end,
				},
				glow = {
				...
				customVisibility = {
					...
					disabled = function()
						return E.db.mui.raidBuffs.visibility ~= "CUSTOM" or not E.db.mui.raidBuffs.enable
					end,
					set = function(info, value)
						E.db.mui.raidBuffs.customVisibility = value
						module:Visibility()
					end,
				},
			},
