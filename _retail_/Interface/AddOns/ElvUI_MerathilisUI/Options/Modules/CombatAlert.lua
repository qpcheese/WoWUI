...
options.CombatAlert = {
	...
	name = L["Combat Alert"],
	get = function(info)
		return E.db.mui.CombatAlert[info[#info]]
	end,
	set = function(info, value)
		E.db.mui.CombatAlert[info[#info]] = value
	...
	args = {
		...
		font = {
			...
			guiInline = true,
			get = function(info)
				return E.db.mui.CombatAlert[info[#info - 1]][info[#info]]
			end,
			set = function(info, value)
				E.db.mui.CombatAlert[info[#info - 1]][info[#info]] = value
				module:RefreshAlert()
			end,
			args = {
				name = {
		...
		style = {
			...
			guiInline = true,
			get = function(info)
				return E.db.mui.CombatAlert.style[info[#info]]
			end,
			set = function(info, value)
				E.db.mui.CombatAlert.style[info[#info]] = value
				module:RefreshAlert()
			end,
			args = {
				font_color_enter = {
		...
		custom_text = {
			...
			guiInline = true,
			get = function(info)
				return E.db.mui.CombatAlert.custom_text[info[#info]]
			end,
			set = function(info, value)
				E.db.mui.CombatAlert.custom_text[info[#info]] = value
				module:RefreshAlert()
			end,
			args = {
				enabled = {
				...
				custom_enter_text = {
					...
					disabled = function(info)
						return not E.db.mui.CombatAlert.custom_text.enabled
					end,
				},
				custom_leave_text = {
					order = 3,
