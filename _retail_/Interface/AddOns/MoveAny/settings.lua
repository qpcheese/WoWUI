...
function MoveAny:InitMALock()
	...
	MoveAny:SetVersion(AddonName, 135994, "1.7.18")
	MALock.TitleText:SetText(format("MoveAny |T135994:16:16:0:0|t v|cff3FC7EB%s", "1.7.18"))
...
function MoveAny:ShowProfiles()
	if MAProfiles == nil then
		...
		MAProfiles.TitleText:SetText(format("MoveAny |T135994:16:16:0:0|t v|cff3FC7EB%s", "1.7.18"))
				...
				MoveAny:CreateMinimapButton(
					{
						...
						["icon"] = 135994,
						["dbtab"] = MATAB,
						["vTT"] = {{"MoveAny |T135994:16:16:0:0|t", "v|cff3FC7EB1.7.18"}, {MoveAny:GT("LID_LEFTCLICK"), MoveAny:GT("LID_MMBTNLEFT")}, {MoveAny:GT("LID_RIGHTCLICK"), MoveAny:GT("LID_MMBTNRIGHT")}},
						["funcL"] = function()
							MoveAny:ToggleMALock()
						end,
						["funcR"] = function()
