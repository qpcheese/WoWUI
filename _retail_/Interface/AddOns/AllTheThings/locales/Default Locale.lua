...
L.SETTINGS_MENU = {
	...
	-- General Page
		...
		DRAKEWATCHERMANUSCRIPTS_CHECKBOX = "|T"..app.asset("Expansion_DF")..":0|t Skyriding Manuscripts";
		DRAKEWATCHERMANUSCRIPTS_CHECKBOX_TOOLTIP = "Enable this option to track Skyriding Manuscripts";
