...
LSM:Register("font", "Expressway MonoNum", "Interface\\AddOns\\EchoRaidTools\\assets\\fonts\\ExpresswayMonoNum.ttf", LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font", "SourceCodePro", "Interface\\AddOns\\EchoRaidTools\\assets\\fonts\\SourceCodePro.ttf", LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font", "Ubuntu", "Interface\\AddOns\\EchoRaidTools\\assets\\fonts\\ubuntu.ttf", LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
