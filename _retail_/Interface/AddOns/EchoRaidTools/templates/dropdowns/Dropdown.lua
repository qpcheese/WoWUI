...
function EchoRaidToolsConfig_PopoutItemTextButtonMixin:OnEnter()
...
function EchoRaidToolsConfig_PopoutItemTextButtonMixin:OnLeave()
    if self.tooltip then
        GameTooltip:Hide()
    end
end
...
function EchoRaidToolsConfig_DropdownMixin:SetupSelections(data, selected)
    ...
    for i, details in ipairs(data) do
        ...
        itemButton.tooltip = details.desc
