...
EchoRaidTools_SimpleTextButtonMixin = {}
function EchoRaidTools_SimpleTextButtonMixin:SetColor(r,g,b,a)

end
function EchoRaidTools_SimpleTextButtonMixin:SetClass(class)

end
function EchoRaidTools_SimpleTextButtonMixin:OnEnter()
    self.BG:Show()
end
function EchoRaidTools_SimpleTextButtonMixin:OnLeave()
    self.BG:Hide()
end